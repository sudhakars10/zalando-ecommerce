...
/**
 * The TestContext class serves as a container for sharing context or state
 ...
 *
 * In this implementation, the TestContext class holds a reference to a
 * WebDriver instance, which can be initialized and accessed by different
 * parts of the test framework, such as Hooks and step definitions.
 *
 * The default constructor is provided to create an instance of TestContext,
